...
func (a *WrapperV1IChain) StateSearchMsg(ctx context.Context, msg cid.Cid) (*apitypes.MsgLookup, error) {
	return a.IChain.StateSearchMsg(ctx, cid.Undef, msg, constants.LookbackNoLimit, true)
}
...
func (a *WrapperV1IChain) StateSearchMsgLimited(ctx context.Context, msg cid.Cid, limit abi.ChainEpoch) (*apitypes.MsgLookup, error) {
	return a.IChain.StateSearchMsg(ctx, cid.Undef, msg, limit, true)
}
...
func (a *WrapperV1IChain) StateGetReceipt(ctx context.Context, msg cid.Cid, from cid.Cid) (*types.MessageReceipt, error) {
