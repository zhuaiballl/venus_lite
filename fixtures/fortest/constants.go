...
import (
	...
	gen "github.com/filecoin-project/venus_lite/tools/gengen/util"
)

// The file used to build these addresses can be found in:
// $GOPATH/src/github.com/filecoin-project/venus_lite/fixtures/setup.json
//
// If said file is modified these addresses will need to change as well
// rebuild using
// TODO: move to build script
// https://github.com/filecoin-project/venus_lite/issues/921
...
// $GOPATH/src/github.com/filecoin-project/venus_lite/tools/gengen/gencfg
