...
type paychDependencyAPI interface {
	StateAccountKey(context.Context, address.Address, cid.Cid) (address.Address, error)
	StateWaitMsg(ctx context.Context, msg cid.Cid, confidence uint64) (*chain.MsgLookup, error)
	WalletHas(ctx context.Context, addr address.Address) (bool, error)
	WalletSign(ctx context.Context, k address.Address, msg []byte) (*crypto.Signature, error)
	StateNetworkVersion(context.Context, cid.Cid) (network.Version, error)
...
func (o *pcAPI) StateAccountKey(ctx context.Context, address address.Address, tsk cid.Cid) (address.Address, error) {
...
func (o *pcAPI) StateNetworkVersion(ctx context.Context, ts cid.Cid) (network.Version, error) {
